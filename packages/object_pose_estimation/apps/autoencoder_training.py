...
import os
import packages.ml
import packages.object_pose_estimation.apps
import shutil
...
flags.DEFINE_string('training_config_path',
                    'packages/object_pose_estimation/apps/training_config.json',
...
def main():
    ...
    node = app.find_node_by_name("pose_estimation_training_samples")
