...
// The webSightServer class serves the frontent web visualization. Data is sent over a websocket
...
class WebsightServer : public isaac::alice::Codelet {
 public:
  ...
  // Path to the assests like pictures
  ...
  ISAAC_PARAM(bool, use_compression, false)
