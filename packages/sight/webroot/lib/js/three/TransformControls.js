...
THREE.TransformControls = function ( camera, domElement ) {
...

	{
		...
		document.addEventListener( "mousemove", onPointerMoveDocument, false );
		domElement.addEventListener( "touchmove", onPointerMove, false );
		document.addEventListener( "mouseup", onPointerUpDocument, false );
	...
	this.dispose = function () {
		...
		document.removeEventListener( "mousemove", onPointerMoveDocument );
		domElement.removeEventListener( "touchmove", onPointerMove );
		document.removeEventListener( "mouseup", onPointerUpDocument );
	...
	function onPointerMoveDocument( event ) {
	...
	function onPointerUpDocument( event ) {
