...
//
// OpenPoseDecoder takes in a TensorListProto containing the Part Affinity Fields tensor and
// Part Affinity Fields, Parts Gaussian Heatmaps, and Parts Gaussian Heatmaps MaxPool tensors.
...
class OpenPoseDecoder : public alice::Codelet {
 public:
  ...
  // The input tensors contain:  PafMap, HeatMap, GaussianHeatMap, MaxPool of GaussianHeatMap
  ...
  ISAAC_PROTO_RX(TensorListProto, tensors);
