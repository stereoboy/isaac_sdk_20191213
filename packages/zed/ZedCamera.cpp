...
bool ZedCamera::initializeZedCamera() {
  ...
  params.camera_disable_imu = !get_capture_imu_data();
...
void ZedCamera::publishGrayData(int64_t acq_time, const sl::CalibrationParameters& camera_params) {
  ...
  SetCameraProtoParameters(camera_params.left_cam, l_camera);
  SetCameraProtoParameters(camera_params.right_cam, r_camera);
