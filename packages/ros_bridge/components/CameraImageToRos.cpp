...
bool CameraImageToRos::protoToRos(ColorCameraProto::Reader reader,
  ...
  // FIXME WAR to send cameraInfo and image_rect with same time stamp to ROS's Apriltag node,
  // to avoid sync failures.
  // Details of ROS's camera Image type to set in this converter
  // is at http://docs.ros.org/api/sensor_msgs/html/msg/Image.html
  ros_message.header.stamp = ros::Time(0.001);
